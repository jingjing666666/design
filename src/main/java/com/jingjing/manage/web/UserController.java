...
import com.jingjing.manage.util.StringUtil;
...
public class UserController {
    ...
    @ResponseBody
    public PageInfo<User> list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "pageSize", required = false) Integer pageSize) throws Exception {
...
//    }
    ...
    public String list1(@RequestParam(value = "page", required = false) String page, @RequestParam(value = "rows", required = false) String rows, User s_user, HttpServletResponse response) throws Exception {
    ...
    public Result delete(@PathVariable(value = "id") Integer id) {
       int resultTotal = userService.deleteUser(id);
        if (resultTotal > 0) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult("FAIL");
